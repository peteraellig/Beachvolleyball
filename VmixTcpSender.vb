...
' eines GET-Requests. Analog zu Tennis26/SoccerClock VmixTcpSender.vb - IP/Port kommen hier
' aus BeachVolleyballScorer.IP/BeachVolleyballScorer.TcpPort.
Public Class VmixTcpSender
    ...
    ' oder wenn sich die IP geändert hat.
    Private Sub EnsureConnected()
        ...
        client.Connect(BeachVolleyballScorer.IP, BeachVolleyballScorer.TcpPort)
